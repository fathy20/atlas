-- ============================================
-- Supabase Seed Data from CSV Exports
...
-- TRUNCATE TABLE public.seo_settings CASCADE;
-- TRUNCATE TABLE public.robots_rules CASCADE;
-- TRUNCATE TABLE public.sitemap_pages CASCADE;
...
-- ============================================
-- 7. User Roles (1 record)
-- Note: This will only work if the user_id exists in auth.users
-- ============================================
INSERT INTO public.user_roles (id, user_id, role, created_at) VALUES
('caa445f6-125c-4b15-9bc7-4e76305df7f5', '94d33ca0-e0bf-42be-877c-608d0deae7b6', 'admin', '2026-03-08 20:43:32.781798+00')
ON CONFLICT (id) DO NOTHING;
